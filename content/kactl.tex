...
\university{KNU}{Taras Shevchenko National University of Kyiv}{knu}
\team{KNU\_LateBloomers}{.}
...
\begin{document}
	...
	Uses code adapted from the KACTL library. Original source: \url{https://github.com/kth-competitive-programming/kactl/}
	\end{multicols*}
\end{document}
